...
import IReport from 'public/partner/shutterstock_2130751070 [Converted]/shutterstock_2130751070 [Converted]@2x.png'
    ...
    <div className="p-[20px]" >
      <div className="w-full h-[469px] bg-white p-[20px] rounded-[20px]  ">
        ...
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <div className="text-[18px] leading-[18px] mt-[30px] mb-[20px]">Coming Soon-Reports</div>
