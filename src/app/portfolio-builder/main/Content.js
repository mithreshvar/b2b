                ...
                <div>
                    ...
                    <div className={`flex flex-col bg-[#F5F7FE] h-[calc(100vh-60px)] relative ${(!(false)) && ' mt-[60px]'} `}> {/* */}
                        ...
                        <div className='flex justify-between items-center h-[80px] shrink-0 text-[14px] font-semibold px-[50px]'>
                            ...
                            <div className=' w-[40px] h-0 border-[#e4e5e5] border-[1px] ' />
                            <button onClick={() => handleRoute('Discussion') } className={` h-[40px] px-[20px] py-[10px] flex justify-center items-center rounded-[25px]  ${active == 'Discussion' ? ' bg-primary text-white ' : ' bg-[#f8f9fa] border-[1px] border-[#e4e5e5] ' } `} >Discussion</button>
                            <div className=' w-[40px] h-0 border-[#e4e5e5] border-[1px] ' />
                        ...
                        <div className={` h-full w-full duration-[0.6s] transition-all overflow-auto z-0`}>
                            {
                                ((active == 'Client Requirement') && <ClientRequirement isLoadClientClicked={isLoadClientClicked} setIsLoadClientClicked={setIsLoadClientClicked} handleNotificationMessage={handleNotificationMessage} />)||
