...
function SWPReport( {setActive} ) {
  ...
  return (
    <div className="flex flex-col p-[20px] gap-y-[20px]" >
      ...
      <CustomTable headers={['Reference Id','Account names','Folio Number','Scheme Name','Status','Amount(Rs.)','SWP Date','Total Installments','Pending Installments','Start Date','End Date']} data={tableData} />
    </div>
  );
}
