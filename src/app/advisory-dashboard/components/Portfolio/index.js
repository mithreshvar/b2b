                                    ...
                                    <div className={` absolute top-[30px] left-0 rounded-[25px] p-[5px] bg-white border-[2px] z-[2] text-[14px] `} style={{width: tablesContainerRef.current.offsetWidth-60+'px', maxHeight: tablesContainerRef.current.offsetHeight+'px' , left: tablesContainerRef.current.scrollLeft +30 +'px', top: showDrillDown.top+'px' }}  >
                                        {
                                            ...
                                            (showDrillDown.tableName == 'Portfolio Quality Risk' && showDrillDown.header == 'Low Rated Fund' ) && <StarRatedHoverPage rate={[3,1]}  height={tablesContainerRef.current.offsetHeight-70+'px'}/> ||
                                            ...
                                            (showDrillDown.tableName == 'Equity Monitor' && showDrillDown.header == '<3 Star Funds' ) && <StarRatedHoverPage fundType={["Equity"]} rate={[2,1]}  height={tablesContainerRef.current.offsetHeight-70+'px'}/> ||
                                            ...
                                            (showDrillDown.tableName == 'Debt Monitor' && showDrillDown.header == '<3 Star Funds' ) && <StarRatedHoverPage fundType={["Debt"]} rate={[2,1]}  height={tablesContainerRef.current.offsetHeight-70+'px'}/> ||
