export default function Arrow ({active=false, left=false, w=6.09, h=10.652}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={w} height={h} viewBox="0 0 6.09 10.652" fill={(active)?"#0071e7":"#6e6e72"}>
